        ...
        <div class="container-fluid py-5">
            <div class="row mt-5">
                ...
                <div class="col-xl-8">
                    <h1>Productos</h1>
                    <div class="row">
                        <?php foreach ($data["lista_productos"] as $elementos): ?>
                        <div class="col-md-4 col-xs-6 col-xl-3 mb-4">
                            <div class="card w-80">
                                <img src="assets/images/productos/<?php echo $elementos['imagen'];?>"
                                    alt="<?php echo $elementos['imagen']; ?>" class="card-img-top">
                                ...
                                <div class="card-footer bg-transparent text-center">
                                    <button class="btn btn-sm btn-success do_add_to_cart" data-cantidad="1"
                                        data-id="<?php echo $elementos['codigo']; ?>" data-toggle="tooltip"

...
class Boleta extends Documento
{
  ...
  function __construct(string $cliente, string $fecha, string $dni, string $telefono, string $fpago, float $subtotal, float $igv, float $total)
  {
    parent::__construct($cliente, $fecha, $dni, $telefono);
  ...
  public function imprimirDocumento(array $productos): string
  {
    ...
    <table>
      <tr>
        <th>BOLETA: 0000010</th>
      </tr>
      <tr>
        <td>CLIENTE:</td><td>{$this->cliente}</td>
      </tr>
      <tr>
        <td>DNI:</td><td>{$this->ruc}</td>
      </tr>
      <tr>

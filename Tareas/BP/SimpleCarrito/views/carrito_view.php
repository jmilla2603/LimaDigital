        ...
        <div class="row">
          <?php foreach ($lista_productos as $producto) { ?>
            <div class="col-md-4 col-xs-6 col-xl-3 mb-4">
              <div class="card w-80">
                <img src="assets/images/productos/<?php echo $producto["imagen"]; ?>" alt="" class="card-img-top">
                <div class="card-body p-2 text-center">
                  <h5 class="card-title card-text text-truncate"><?php echo $producto["nombre"]; ?>
                  </h5>
                  <p class="text-success"><?php echo $producto["precio"]; ?></p>
                </div>
                <div class="card-footer bg-transparent text-center">
                  <button class="btn btn-sm btn-success do_add_to_cart" data-cantidad="1" data-id="" data-toggle="tooltip" title="Agregar al carrito">
